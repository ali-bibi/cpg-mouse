...
def dc_source_to_sensors (t, f_left_dc_source, f_right_dc_source, h_left_dc_source, h_right_dc_source):
    ...
    h_left_dc_source.amplitude = 0.0395 + 0.001 * random()
    f_left_dc_source.amplitude = 0.0395 + 0.001 * random()
    f_right_dc_source.amplitude = 0.0395 + 0.001 * random()
    h_right_dc_source.amplitude = 0.0395 + 0.001 * random()